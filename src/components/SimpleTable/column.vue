<template>
  <div>
    ...
    <template v-for="(column, index) in columns">
      ...
      <el-table-column v-else-if="column.type === 'index'" :key="index" :label="column.header" :width="column.width" :type="column.type" align="center" />
      <el-table-column v-else-if="column.type === 'fixcode'" :key="index" :label="column.header" :width="column.width" :type="column.type" :prop="column.dataIndex" :formatter="getFixCodeDesc" align="center" />
    </template>
